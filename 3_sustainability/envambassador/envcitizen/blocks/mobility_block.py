...
class PlaceSelectionBlock(Block):
    ...
    async def forward(self, step, plan_context):
        ...
        try:
            ...
            levelOneType = json_repair.loads(clean_json_response(levelOneType))["place_type"]
        ...
        try:
            ...
            levelTwoType = json_repair.loads(clean_json_response(levelTwoType))["place_type"]
        except Exception as e:
        ...
        try:
            ...
            radius = int(json_repair.loads(radius)["radius"])
        except Exception as e:
...
class MoveBlock(Block):
    ...
    async def forward(self, step, plan_context):
        ...
        try:
            ...
            response = json_repair.loads(response)["place_type"]
        except Exception:
            get_logger().warning(
        ...
        if response == "home":
            ...
            if logging_flag:
                ...
                try:
                    transportation_mode = json_repair.loads(transportation_mode)["transportation_mode"]
